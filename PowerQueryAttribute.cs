...
namespace ITLec.RaiseYourVoice
{
   public  class PowerQueryAttribute
    {
        ...
        bool isLinkEntityAttribute = false;
        public bool IsLinkEntityAttribute
        {
            get
            {
                return isLinkEntityAttribute;
            }
            set
            {
                 isLinkEntityAttribute= value;
            }
        }
        ...
        public bool HasFormattedValue
        {
            ...
            {
                bool retVal = false;
                if ((AttributeMetadata != null && !Name.StartsWith("_") && 
                    ( IsLinkEntityAttribute?true: !Name.Contains(".") )
                    && !Name.Contains("@")
                && Type != AttributeType.Uniqueidentifier && Type != AttributeType.String && Type!= AttributeType.EntityName && Type != AttributeType.Decimal)
        ...
        FetchXmlAttributeDetail fetchXmlAttributeDetail = null;

        public FetchXmlAttributeDetail FetchXmlAttributeDetail {

            get
            {
            //    if(fetchXmlAttributeDetail == null)
                    fetchXmlAttributeDetail = new FetchXmlAttributeDetail(Name, DisplayName, Type, AttributeMetadata);

                return fetchXmlAttributeDetail;
            }
            set
            {
                fetchXmlAttributeDetail = value;
            }
        }

        ODataAttributeDetail oDataAttributeDetail = null;
        public ODataAttributeDetail ODataAttributeDetail
        {
            get
            {
                if (oDataAttributeDetail == null)
                    oDataAttributeDetail = new ODataAttributeDetail(Name, DisplayName, Type, AttributeMetadata);
                return oDataAttributeDetail;
            }
            set
            {
                oDataAttributeDetail = value;
            }
        }
        ...
        public static PowerQueryAttribute GetNewObject(PowerQueryAttribute powerQueryAttribute)
        {
            ...
            _powerQueryAttribute.IsLinkEntityAttribute = powerQueryAttribute.IsLinkEntityAttribute;
    ...
    public class FetchXmlAttributeDetail
    {
        public FetchXmlAttributeDetail(string name, string displayName,string type, AttributeMetadata attributeMetadata)
        {
            ...
            //        || attributeMetadata is Microsoft.Xrm.Sdk.Metadata.StateAttributeMetadata
            //        || attributeMetadata is Microsoft.Xrm.Sdk.Metadata.StatusAttributeMetadata
            //        || attributeMetadata is Microsoft.Xrm.Sdk.Metadata.BooleanAttributeMetadata)
            //        {
